    ...
    <main className="Sheet">
      ...
      <Switch>
        <Route
          ...
          render={props => <UpdateSheetForm {...props} character={character} setCharacter={setCharacter} id={id} />}
        />
        <Route path={`${props.match.path}`} render={props => <PlaySheet {...props} character={character} />} />
      </Switch>
    </main>
  );
};
